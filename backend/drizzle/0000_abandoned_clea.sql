...
ALTER TABLE "date_data" ADD CONSTRAINT "date_data_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "cards_deck_id_state_due_idx" ON "cards" USING btree ("deck_id","state","due");--> statement-breakpoint
